      ...
      <div className="row mx-auto">
        ...
        <div className="col-md-4 my-3 text-right text-uppercase text-secondary">
            <form>
              ...
              className="form-control mb-4" value={address}
              onChange={e => setAddress(e.target.value)} />

              {/* <label htmlFor="mobile">Mobile</label> */}
              <input type="text" name="mobile" id="mobile" placeholder="Enter your phone number"
              className="form-control mb-4" value={mobile}
              onChange={e => setMobile(e.target.value)} />
            </form>

            <h3 class="font-weight-bold">Total: <span className="text-danger font-weight-bold">${total}</span></h3>
